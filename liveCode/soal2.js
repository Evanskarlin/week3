...
var height = 125;// silahkan beri nilai
var accompaniedByAdult = false// silahkan beri nilai


function syarat(money, age, height, accompaniedByAdult){
if (money<15000) {
    return "Maaf, uang kamu tidak cukup";
}
if(age<7 || height<125){
    return "Kamu belum diperbolehkan menaiki wahana ini";
}
if (age<10 && accompaniedByAdult == false) {
    return "Kamu harus ditemani oleh orang dewasa untuk menaiki wahana ini";
}
else{
    return "Selamat menikmati wahana ini";
}
}

console.log(syarat(money, age, height, accompaniedByAdult));