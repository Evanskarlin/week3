...
// 4. apabila 'pengurangan' lebih besar dari pada satu maka lanjut ke step 7. bila tidak lanjut ke step 5
...
// WHILE 'pengurangan' bigger by 1 THEN
...
var prima = 15;
var count = 0;
var pengurangan= prima-1;
while(pengurangan>1){
    if (prima%pengurangan === 0){
        count += 1;
    }
    pengurangan -=1;
}
